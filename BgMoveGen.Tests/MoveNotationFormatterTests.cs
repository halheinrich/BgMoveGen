...
public class MoveNotationFormatterTests
{
    ...
    {
        var result = MoveNotationFormatter.Format(Play.Create(new Move(13, 8)));
    ...
    {
        var result = MoveNotationFormatter.Format(Play.Create(new Move(25, 21)));
    ...
    {
        var result = MoveNotationFormatter.Format(Play.Create(new Move(25, -22)));
    ...
    {
        var result = MoveNotationFormatter.Format(
            Play.Create(new Move(25, 23), new Move(25, 23)));
    ...
    {
        var result = MoveNotationFormatter.Format(Play.Create(new Move(2, 0)));
    ...
    {
        var result = MoveNotationFormatter.Format(Play.Create(
    ...
    {
        var result = MoveNotationFormatter.Format(Play.Create(new Move(24, -18)));
    ...
    public void Format_HitAtIntermediatePreventsForwardChainCollapse()
    {
        ...
        // to "24/17".
        var result = MoveNotationFormatter.Format(
            Play.Create(new Move(24, -18), new Move(18, 17)));
    ...
    public void Format_PairMixedHits_GroupsWithAsteriskAfterCount()
    {
        ...
        var result = MoveNotationFormatter.Format(
            Play.Create(new Move(6, -2), new Move(6, 2)));
    ...
    public void Format_SameCheckerChainOutOfOrder_CollapsesSame()
    {
        ...
        var result = MoveNotationFormatter.Format(
            Play.Create(new Move(20, 14), new Move(21, 20)));
    ...
    {
        var result = MoveNotationFormatter.Format(
            Play.Create(new Move(25, 21), new Move(21, 15)));
    ...
    {
        var result = MoveNotationFormatter.Format(
            Play.Create(new Move(4, 1), new Move(1, 0)));
